...
export default ({
  ...
  methods: {
    updateChallenge(challengeId) {
      ...
      tl
          .to(this.$refs.popup, {
            x: -80, opacity: 0, duration: 0.00, display: 'block',
          })
          .to(this.$refs.popup, {
            x: 0, opacity: 1, duration: 0.30, display: 'block',
          })
          .to(this.$refs.popup, {
            x: 0, opacity: 1, duration: 1.50, display: 'block',
          })
          .to(this.$refs.popup, {
            x: 80, opacity: 0, duration: 0.30, display: 'none',
          });
      setTimeout(() => {
